        ...
        @if (Auth::user())
            <div class="head_user">
                ...
                <div uk-dropdown="mode:click ; pos: bottom-center ; animation: uk-animation-scale-up"
                    ...
                    <a href="#" class="icon-menu-item"
                        data-bs-toggle="modal"
                        data-bs-target="#postPodcast">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="#f25e4e"
                                d="M29,19H5V8H19M16,1V3H8V1H6V3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3H18V1M17,12H12V17H17V12Z">
                            </path>
                        </svg>
                        Podcast </a>
                    <a id="ver-mais" hidden="" href="#" class="icon-menu-item" data-bs-toggle="modal" data-bs-target="#criarGrupo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path fill="#03A9F4"
