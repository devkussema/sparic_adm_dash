                                        ...
                                        <form class="needs-validation" novalidate>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                    ...
                                                    <select class="form-select select2" id="validationCustom14"
                                        ...
                                        <form>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                    ...
                                                    <select class="form-select select2 form-control is-invalid"
                                        ...
                                        <form class="needs-validation" novalidate>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                                    ...
                                                    <select class="form-select form-control select2" id="validationTooltip04"
                                                        required>
                                                        <option selected disabled value="">Choose...</option>
                                                        <option>USA</option>
                                                        <option>UK</option>
